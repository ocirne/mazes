...
fun main() {
    ...
    saveImage(maze.toImage(backgroundColors = colorization1), "cartesian_recursive_backtracker_colorized1")

    val colorization2 = Colorization(maze).countLinks()
    saveImage(maze.toImage(backgroundColors = colorization2), "cartesian_recursive_backtracker_colorized2")
}
